...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cetus " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed.cetuscoin.cc", "seed.cetuscoin.cc"},
	{"seed2.cetuscoin.cc", "seed2.cetuscoin.cc"},
	{"seed3.cetuscoin.cc", "seed3.cetuscoin.cc"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cetus is probably already running."), addrBind.ToString().c_str());
        else
