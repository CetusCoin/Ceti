...
int64 nChainStartTime = 1411730342;
...
const string strMessageMagic = "Cetus Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Cetus
    bool fStrictPayToScriptHash = true; // Always active in Cetus
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Cetus", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Fri, 26 Sep 2014 11:19:02 GMT";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xb80a3c0115b6fedb5a396505e6db2637661392717d702c84adeb0f78d5d8cab9"));
